/*******************************************************
 * ESITapTradeApiSimpleDemoJavaIdeaIC2018_X64
 * www.xfinapi.com
 *******************************************************/
...
public class Main {
    ...
    static void MarketTest() {
        ...
        market = XFinApi.TradeApi.ITradeApi.XFinApi_CreateMarketApi("XTA_W64/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApi.dll", err);
    ...
    static void TradeTest() {
        ...
        trade = XFinApi.TradeApi.ITradeApi.XFinApi_CreateTradeApi("XTA_W64/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApi.dll", err);
