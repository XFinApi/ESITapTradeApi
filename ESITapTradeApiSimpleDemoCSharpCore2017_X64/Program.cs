/*******************************************************
* ESITapTradeApiSimpleDemoCSharpCore2017_X64
* www.xfinapi.com
*******************************************************/
using System;
...
namespace ESITapTradeApiSimpleDemoCSharpCore2017_X64
{
    class Program
    {
        //////////////////////////////////////////////////////////////////////////////////
        ...
        static void MarketTest()
        {
            ...
            market = ITradeApi.XFinApi_CreateMarketApi("XTA_W64/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApi.dll", out err);
        ...
        static void TradeTest()
        {
            ...
            trade = ITradeApi.XFinApi_CreateTradeApi("XTA_W64/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApi.dll", out err);
