/*******************************************************
* ESITapTradeApiSimpleDemoVC2015
* www.xfinapi.com
*******************************************************/
...
2.拷贝XTA_W32\Api\ESITap_vX.X.X.X_XXXXXXXX目录（X.X.X.X_XXXXXXXX为版本号）下的所有dll文件到可执行文件目录，
...
void MarketTest()
{
	...
	int err = -1;
#ifdef _DEBUG
	market = XFinApi_CreateMarketApi("XTA_W32/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApid.dll", &err);
#else
	market = XFinApi_CreateMarketApi("XTA_W32/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApi.dll", &err);
#endif
...
void TradeTest()
{
	...
	int err = -1;
#ifdef _DEBUG
	trade = XFinApi_CreateTradeApi("XTA_W32/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApid.dll", &err);
#else
	trade = XFinApi_CreateTradeApi("XTA_W32/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApi.dll", &err);
#endif
	if (err || !trade)
	{
