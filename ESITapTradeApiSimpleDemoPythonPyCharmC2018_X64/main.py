######################################################
# ESITapTradeApiSimpleDemoPythonPyCharmC2018_X64
# www.xfinapi.com
######################################################
...
class MarketTest:
    ...
    def test(self):
        self.market = XFinApi_TradeApi.XFinApi_CreateMarketApi("XTA_W64/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApi.dll")
...
class TradeTest:
    ...
    def Test(self):
        ...
        self.trade = XFinApi_TradeApi.XFinApi_CreateTradeApi("XTA_W64/Api/ESITap_v9.3.0.1_20160406/XFinApi.ESITapTradeApi.dll")
